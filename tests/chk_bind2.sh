...
b=$(get_count)
umount /tmp/tlp-test/slave/bind-dest
c=$(get_count)
...
(( c < b )) || fail "umount in slave area didn't decrease usage count"
(( d < c )) || fail "umount in shared area didn't decrease usage count"
(( d == a )) || fail "usage count not restored after shared umount"
